...
export default function PrivacyPolicy () {
  return (
    <>
      {/* <div className='relative w-full lg:h-[500px] h-[200px] max-w-screen'>
        <div className='absolute z-[1] inset-0 text-white text-center flex flex-col justify-center items-center'>
          <p className='font-bold text-4xl'>개인정보처리방침</p>
          <p className='font-light text-sm mt-1'>Privacy Policy</p>
        </div>
        <div className='block'>
          <div className='bg-gradient-to-r from-jju-steps-from to-jju-steps-to lg:h-[80px] h-[100px]' />
          <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1440 320' className='rotate-180'>
            <defs>
              <linearGradient id='gradient' x1='0%' x2='100%' y1='0%' y2='0%'>
                <stop offset='0%' stopColor='#02ABEE' />
                <stop offset='100%' stopColor='#014B8C' />
              </linearGradient>
            ...
            <path fill='url(#gradient)' filter='url(#shadow)' d='M0,288L60,256C120,224,240,160,360,112C480,64,600,32,720,58.7C840,85,960,171,1080,218.7C1200,267,1320,277,1380,282.7L1440,288L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z'/>
            <path fill='url(#gradient)' filter='url(#shadow)' d='M0,128L80,149.3C160,171,320,213,480,197.3C640,181,800,107,960,96C1120,85,1280,139,1360,165.3L1440,192L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z'/>
            <path fill='url(#gradient)' filter='url(#shadow)' d='M0,64L120,96C240,128,480,192,720,202.7C960,213,1200,171,1320,149.3L1440,128L1440,0L1320,0C1200,0,960,0,720,0C480,0,240,0,120,0L0,0Z' />
          </svg>
        </div>
      </div> */}
        ...
        <div className='pb-20 px-4'>
          <div className='flex space-x-4 font-bold text-xl'>
            <Link href='/' className='self-center'>
              <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor' className='size-5 hover:text-jju-steps-to duration-200 ease-in-out'>
          ...
          <div className='mt-16 space-y-6'>
            ...
            <section>
              <h2 className='text-lg font-semibold'>2. 개인정보의 처리 및 보유 기간</h2>
            ...
            <section>
              <h2 className='text-lg font-semibold'>3. 처리하는 개인정보의 항목</h2>
            ...
            <section>
              <h2 className='text-lg font-semibold'>4. 개인정보의 파기절차 및 방법</h2>
            ...
            <section>
              <h2 className='text-lg font-semibold'>5. 개인정보의 안전성 확보조치</h2>
            ...
            <section>
              ...
              <ul className='list-disc list-inside mt-2'>
                ...
                <li>직책: 개인정보보호팀장</li>
                <li>연락처: 000-0000-0000, privacy@example.com</li>
              </ul>
            </section>

            <section>
              <h2 className='text-lg font-semibold'>7. 개인정보 열람청구</h2>
              ...
              <ul className='list-disc list-inside mt-2'>
                ...
                <li>담당자: OOO</li>
                <li>연락처: 000-0000-0000, privacy_request@example.com</li>
              </ul>
            </section>

            <section>
              <h2 className='text-lg font-semibold'>8. 권익침해 구제방법</h2>
