      ...
      <Container>
        <div className='text-white px-4 py-10'>
          <div className='flex flex-col'>
            <div>
              <p className='font-bold md:text-4xl text-2xl'>ICBM Labs</p>
              <div className='mt-1 font-light md:text-[15px] text-sm'>
                <p>ICBM Labs in Jeonju University Club,</p>
                <p>Grows together goes together with ICBM Labs.</p>
              </div>
            </div>
            <div className='flex flex-row mt-6 justify-between'>
              <div className='flex space-x-4 self-center'>
                ...
                <Link href='https://www.jj.ac.kr/cse/' target='_blank' className='self-center'>
              ...
              <div className='flex space-x-4 font-light text-sm self-end'>
          ...
          <p className='font-extralight md:text-sm text-xs'>&copy; 2024 ICBM Labs in Jeonju University. All Rights Reserved.</p>
        </div>
      </Container>
    </footer>
  )
